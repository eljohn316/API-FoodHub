...
def upgrade():
    ...
    op.create_table('accepted_reservations',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('accepted_reservation_id', sa.Integer(), nullable=False),
    sa.Column('owner_id', sa.Integer(), nullable=True),
    sa.Column('date_approved', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['accepted_reservation_id'], ['reservations.id'], ),
    sa.ForeignKeyConstraint(['owner_id'], ['users.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('declined_reservations',
    sa.Column('id', sa.Integer(), nullable=False),
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_table('declined_reservations')
    op.drop_table('accepted_reservations')
